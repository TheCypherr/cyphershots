      ...
      <div className="inner-gallery">
        ...
        <div className="flex-container2">
          ...
          <h3>
            ...
            distinctio consectetur! Harum nisi magnam earum reiciendis eius
            labore dignissimos sit repudiandae modi, iste vitae exercitationem
            laboriosam? Cumque, blanditiis eligendi dolor quidem laborum
            accusantium vitae eveniet asperiores eius expedita minima harum?
          </h3>
          <div className="r-btn">
            <Link to="/">
              <button>&lt; Back</button>
