      ...
      <div className="inner-gallery">
        ...
        <div className="flex-container2">
          ...
          <h3>
            ...
            libero minima eius, assumenda illo quis necessitatibus quasi,
            molestiae, debitis dolorum exercitationem. Dolor explicabo ad ipsam
            quam accusantium, quisquam quo.
          </h3>
          <div className="r-btn">
            <Link to="/">
              <button>&lt; Back</button>
